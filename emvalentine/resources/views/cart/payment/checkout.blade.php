                            ...
                            <table class="table table-responsive table-striped ">
                                ...
                                <tfoot>
                                    ...
                                    <tr>
                                        ...
                                        <th  style="border-top: solid 1px #29a329"> <span id="total_tr" >S/. {{ number_format($newSubtotal , 2) }}</span></th>
                                    </tr>
                                </tfoot>
                            </table>
...
<script>
    ...
    Culqi.publicKey = 'sk_test_xE80APXMsdprbzQ9';
        ...
        if(valid)
        {
            ...
            else
            {
                ...
                Culqi.settings({
                    title: 'Em Valentine',
                    currency: 'PEN',
                    description: 'Ropa, accesorios y calzado femeninos',
                    amount: subtotal
                });
