...
<body>
    ...
    <!-- <div id="preloader">
        ...
        <div class="preload-icons">
            <img class="preload-1" src="{{ asset('cliente_assets/images/favicon.png') }}" alt="">
            <img class="preload-2" src="{{ asset('cliente_assets/images/favicon.png') }}" alt="">
        </div>
    </div> -->
                        ...
                        <div class="col-md-3 col-sm-4 col-xs-3">  
                            <ul class="menu-extra">
                                ...
                                <li class="dropdown">
                                    ...
                                    <li class="dropdown-item"><a href="{{ url('/profile/data') }}">Perfil</a></li>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                            <div class="copyright__inner">
                                <div class="copyright">
                                    <p>© 2018 Derechos reservados | <a href="#"> elpibeperu.com</a></p>
                                </div>
                                <ul class="social__icon">
                                    <li><a href="https://www.facebook.com/elpibeperu/" target="_blank"><i class="zmdi zmdi-facebook"></i></a></li>
                                    <li><a href="https://twitter.com/ElPibeHuancayo" target="_blank"><i class="zmdi zmdi-twitter"></i></a></li>
                                    <li><a href="https://www.instagram.com/elpibeperu/" target="_blank"><i class="zmdi zmdi-instagram"></i></a></li>
                                    <li><a href="https://plus.google.com/107825534306386311562/" target="_blank"><i class="zmdi zmdi-google-plus"></i></a></li>
                                    <li><a href="https://www.pinterest.es/elpibehuancayo/" target="_blank"><i class="zmdi zmdi-pinterest"></i></a></li>
                                </ul>
                                <ul class="footer__menu">
                                    <li><a href="/">Inicio</a></li>
                                    <li><a href="/productos">Productos</a></li>
                                    <li><a href="/contacto">Contactanos</a></li>
                                    <li><a href="/terminos_y_condiciones" target="_blank">Terminos y Condiciones</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
