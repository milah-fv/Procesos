...
@section ('centro')
        ...
        <div class="slider__container slider--one">
            <div class="slider__activation__wrap owl-carousel owl-theme">
                <!-- Start Single Slide -->
                <div class="slide slider__full--screen" style="background: rgba(0, 0, 0, 0) url({{$slider->image}}) no-repeat scroll center center / cover ;">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-10 col-lg-8 col-md-offset-2 col-lg-offset-4 col-sm-12 col-xs-12">
                                    <div class="slider__inner" style="background:  #ffffff4d; padding:30px 0px;">
                                        <h1> <span class="text--theme" style=" font-size: 90px; ">Nuevos Productos</span></h1>
                                        <div class="slider__btn">
                                            <a class="htc__btn" href="{{$slider->url}}">Ver productos</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="product__inner">
                                        ...
                                        <div class="product__hover__info">
                                            <ul class="product__action">
                                                ...
                                                <!-- <li><a data-toggle="modal" data-target="#productModal" title="Vista Rápida" class="quick-view modal-view detail-link" href="#"><span class="ti-plus"></span></a></li> -->
                                                <li>
                                                ...
                                                <!-- <li><a title="Lista de Deseos" href="wishlist.html"><span class="ti-heart"></span></a></li> -->
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div class="product foo" style="margin-top:20px">
                                    <div class="product__inner">
                                        ...
                                        <div class="product__hover__info">
                                            <ul class="product__action">
                                                <li><a data-toggle="modal" data-target="#productModal" title="Vista rápida" data-id="{{ $product->id }}" class="quick-view modal-view detail-link showProduct" href="#"><span class="ti-plus"></span></a></li>
                                                <!-- <li><a data-toggle="modal" title="Vista rápida" data-id="{{ $product->id }}" class="quick-view modal-view detail-link showProduct" href="#"><span class="ti-plus"></span></a></li> -->
                                                <li>
                                                @if($product->sizes->isEmpty())
                                                    <a title="Añadir al carrito"  class="addCartProduct" data-id="{{ $product->id }}" href="javascript:void(0)">
                                                        <span class="ti-shopping-cart"></span>
